...
const projects = [
  {
    ...
    description:
      "A modern and interactive pizza delivery website prototype focusing on user-friendly navigation and smooth ordering flow.",
  ...
  },
  {
    ...
    description:
      "A sleek frontend design showcasing Sony’s DualSense wireless controller with high-quality visuals and engaging layout.",
    img: "/assets/game.jpg",
  ...
  },
  {
    ...
    description:
      "An aesthetic coffee brand website emphasizing minimal UI, cozy theme, and smooth browsing experience for users.",
  ...
  },
  {
    ...
    description:
      "A clean and modern UI kit for food delivery apps with engaging layouts, menu browsing, and order tracking screens.",
    img: "/assets/food.jpg",
  ...
  },
  {
    ...
    description:
      "A fully responsive clothing e-commerce website built with HTML, CSS, and JavaScript.",
